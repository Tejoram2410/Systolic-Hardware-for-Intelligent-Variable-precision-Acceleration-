...
# Design: Ultra-Low-Power 2x2 PE Reconfigurable Baugh-Wooley MAC Architecture
# Target RTL: rtl/mac_reconfig_baugh_wooley.sv
...
# Step 2: Procedure to perform Joules activity propagation and power report
proc run_power_report {vcd_file top_tb report_name} {
    ...
    read_hdl -v2001 output_files/mac_reconfig_baugh_wooley_netlist.v
    elaborate mac_reconfig_baugh_wooley
...
run_power_report "mac_reconfig_baugh_wooley_int4_max.vcd"     "mac_reconfig_baugh_wooley_tb_int4_max"     "mac_reconfig_baugh_wooley_power_int4_max.rpt"
run_power_report "mac_reconfig_baugh_wooley_int4_avg.vcd"     "mac_reconfig_baugh_wooley_tb_int4_avg"     "mac_reconfig_baugh_wooley_power_int4_avg.rpt"
run_power_report "mac_reconfig_baugh_wooley_int8_max.vcd"     "mac_reconfig_baugh_wooley_tb_int8_max"     "mac_reconfig_baugh_wooley_power_int8_max.rpt"
run_power_report "mac_reconfig_baugh_wooley_int8_avg.vcd"     "mac_reconfig_baugh_wooley_tb_int8_avg"     "mac_reconfig_baugh_wooley_power_int8_avg.rpt"
run_power_report "mac_reconfig_baugh_wooley_combined_max.vcd" "mac_reconfig_baugh_wooley_tb_combined_max" "mac_reconfig_baugh_wooley_power_combined_max.rpt"
run_power_report "mac_reconfig_baugh_wooley_combined_avg.vcd" "mac_reconfig_baugh_wooley_tb_combined_avg" "mac_reconfig_baugh_wooley_power_combined_avg.rpt"

puts "\n========================================================"
puts "  ALL 6 BAUGH-WOOLEY POWER SIGN-OFF REPORTS GENERATED!"
puts "========================================================\n"
exit
