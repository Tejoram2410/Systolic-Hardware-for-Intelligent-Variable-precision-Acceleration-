//-----------------------------------------------------------------------------
// Module: mac_reconfig_2d_baugh_wooley_baseline.sv
// Description: BASELINE MAC Tile (Golden 3.966 mW / 1,356 Cell Architecture).
//              Used for direct side-by-side Silicon Area and Power benchmarking.
// Precision Modes:
...
//=============================================================================
module baugh_wooley_4b_pe_baseline (
    input  logic [3:0] a,
    input  logic [3:0] b,
    input  logic       sign_a,
    input  logic       sign_b,
...
//=============================================================================
// Top-Level Baseline 2D Reconfigurable MAC Tile
//=============================================================================
module mac_reconfig_2d_baugh_wooley_baseline (
    input  logic              clk,
    input  logic              rst_n,
    ...
    baugh_wooley_4b_pe_baseline u_pe00 (.a(a0_iso), .b(b0_iso), .sign_a(sign_a_00), .sign_b(sign_b_00), .prod(P_00_raw));
    baugh_wooley_4b_pe_baseline u_pe01 (.a(a1_iso), .b(b1_iso), .sign_a(sign_a_01), .sign_b(sign_b_01), .prod(P_01_raw));
    baugh_wooley_4b_pe_baseline u_pe10 (.a(a2_iso), .b(b2_iso), .sign_a(sign_a_10), .sign_b(sign_b_10), .prod(P_10_raw));
    baugh_wooley_4b_pe_baseline u_pe11 (.a(a3_iso), .b(b3_iso), .sign_a(sign_a_11), .sign_b(sign_b_11), .prod(P_11_raw));
    ...
    //    Reuses physical adder hardware between 8x4 Row Mode and 4x8 Col Mode
    ...
    // Mode 11: Unified 8x8 Mode Partial Product Fusion Tree (mergeC - Technology Mapped)
    ...
    // 5. Input-Muxed Accumulator Core with Direct Clock-Enables inside Sequential Block
