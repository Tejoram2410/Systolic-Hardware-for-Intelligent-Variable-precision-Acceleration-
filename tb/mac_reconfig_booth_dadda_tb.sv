//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_tb.sv
// Description: Self-checking Testbench for Strict 4-Wire Radix-4 Booth &
//              Reconfigurable Dadda Tree MAC Architecture (mac_reconfig_booth_dadda.sv)
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_tb;
    ...
    // Task to run 4-bit SIMD test case
    ...
    // Task to run 8-bit Unified test case
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_tb.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_tb.dut);
        ...
        $display("==================================================================");
        $display(" STARTING BOOTH & DADDA RECONFIGURABLE MAC SIMULATION VERIFICATION ");
        $display("==================================================================");
        ...
        $display("==================================================================");
        $display(" ALL TESTS PASSED: %0d / %0d Assertions Verified Cleanly", pass_count, test_count);
