//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_tb_int8_avg.sv
// Description: Realistic Average Power INT8 Testbench for mac_reconfig_booth_dadda
//              (~60% Duty Cycle, Mixed Operands & Pauses)
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_tb_int8_avg;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_int8_avg.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_tb_int8_avg.dut);
        ...
        $display("==========================================================");
        $display(" STARTING INT8 AVG POWER SIMULATION (REALISTIC 60%% WORKLOAD)");
        $display("==========================================================");
        ...
        $display("[PASS] 8-bit Unified: INT8 Avg Power Simulation Completed (%0d cycles)", test_count);
