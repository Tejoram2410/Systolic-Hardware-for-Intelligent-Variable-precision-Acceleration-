//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_pdk_tb_combined_max.sv
// Description: Peak Max Power Dynamic Switching Testbench for mac_reconfig_booth_dadda_pdk
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_pdk_tb_combined_max;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_pdk_combined_max.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_pdk_tb_combined_max.dut);
        ...
        $display("==========================================================");
        $display(" STARTING PDK COMBINED MAX POWER SIMULATION (100%% DUTY CYCLE)");
        $display("==========================================================");
        ...
        @(posedge clk);
        $display("[PASS] Combined: PDK Combined Max Power Simulation Completed (200 cycles)");
