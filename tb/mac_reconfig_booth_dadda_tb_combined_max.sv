//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_tb_combined_max.sv
// Description: Peak Max Power Combined Testbench for mac_reconfig_booth_dadda
//              (100% Duty Cycle, Mode Switching on Every Cycle & Max Flips)
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_tb_combined_max;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_combined_max.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_tb_combined_max.dut);
        ...
        $display("[PASS] 4-bit SIMD: Combined Max Power Simulation Completed (%0d cycles)", test_count);
