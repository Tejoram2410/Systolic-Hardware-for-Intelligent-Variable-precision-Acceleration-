//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_pdk_tb_int8_max.sv
// Description: Peak Max Power INT8 Testbench for mac_reconfig_booth_dadda_pdk
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_pdk_tb_int8_max;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_pdk_int8_max.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_pdk_tb_int8_max.dut);
        ...
        $display("==========================================================");
        $display(" STARTING PDK INT8 MAX POWER SIMULATION (100%% DUTY CYCLE)");
        $display("==========================================================");
        ...
        @(posedge clk);
        $display("[PASS] 8-bit Unified: PDK INT8 Max Power Simulation Completed (200 cycles)");
