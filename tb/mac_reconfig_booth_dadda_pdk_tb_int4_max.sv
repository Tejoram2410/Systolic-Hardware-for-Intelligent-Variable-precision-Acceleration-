//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_pdk_tb_int4_max.sv
// Description: Peak Max Power INT4 Testbench for mac_reconfig_booth_dadda_pdk
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_pdk_tb_int4_max;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_pdk_int4_max.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_pdk_tb_int4_max.dut);
        ...
        $display("==========================================================");
        $display(" STARTING PDK INT4 MAX POWER SIMULATION (100%% DUTY CYCLE)");
        $display("==========================================================");
        ...
        @(posedge clk);
        $display("[PASS] 4-bit SIMD: PDK INT4 Max Power Simulation Completed (200 cycles)");
