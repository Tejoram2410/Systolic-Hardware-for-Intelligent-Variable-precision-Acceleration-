//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_tb_int4_max.sv
// Description: Peak Max Power INT4 Testbench for mac_reconfig_booth_dadda
//              (100% Duty Cycle, 0x5 <-> 0xA Flips, +7 <-> -8 Extremes)
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_tb_int4_max;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_int4_max.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_tb_int4_max.dut);
        ...
        $display("==========================================================");
        $display(" STARTING INT4 MAX POWER SIMULATION (100%% DUTY CYCLE)");
        $display("==========================================================");
        ...
        $display("[PASS] 4-bit SIMD: INT4 Max Power Simulation Completed (%0d cycles)", test_count);
