//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_pdk_tb_combined_avg.sv
// Description: Realistic Average Power Dynamic Switching Testbench for mac_reconfig_booth_dadda_pdk
//              (Matches exact 3-phase workload: 20% zero-load, 40% stationary, 40% random)
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_pdk_tb_combined_avg;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_pdk_combined_avg.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_pdk_tb_combined_avg.dut);
        ...
        $display("==========================================================");
        $display(" STARTING PDK COMBINED AVG POWER SIMULATION (REALISTIC 60%% WORKLOAD)");
        $display("==========================================================");
        ...
        $display("[PASS] Combined: PDK Combined Avg Power Simulation Completed (%0d cycles)", test_count);
