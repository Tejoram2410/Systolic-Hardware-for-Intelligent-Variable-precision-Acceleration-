//-----------------------------------------------------------------------------
// Module: mac_reconfig_booth_dadda_tb_combined_avg.sv
// Description: Realistic Average Power Combined Testbench for mac_reconfig_booth_dadda
//              (~60% Duty Cycle, Mixed Operands & Inter-Layer Pauses)
//-----------------------------------------------------------------------------
`timescale 1ns / 1ps

module mac_reconfig_booth_dadda_tb_combined_avg;
    ...
    initial begin
        $dumpfile("mac_reconfig_booth_dadda_combined_avg.vcd");
        $dumpvars(0, mac_reconfig_booth_dadda_tb_combined_avg.dut);
        ...
        $display("[PASS] 4-bit SIMD: Combined Avg Power Simulation Completed (%0d cycles)", test_count);
